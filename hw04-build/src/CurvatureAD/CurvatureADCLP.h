...
//  /nfs/s-l011/local/vol02/p/parthghosh/SlicerExecutionModel/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/src/CurvatureAD/CurvatureAD.xml --OutputCxx /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/hw04-build/src/CurvatureAD/CurvatureADCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>Curvature Anisotropic Diffusion Filter</title>\n"
"    <description>\n"
"        Applies curvature-based anisotropic diffusion to a 3D NIFTI image.\n"
"        Smooths along iso-intensity contours (level sets) rather than across them,\n"
"        which tends to produce cartoon-like smoothing with sharper flat regions.\n"
"        Controlled by conductance, timeStep, and iterations.\n"
...
"        <description>Anisotropic diffusion parameters.</description>\n"
"\n"
"        <double>\n"
"            <name>conductance</name>\n"
"            <longflag>conductance</longflag>\n"
"            <description>Conductance parameter. Higher values allow more diffusion. Typical range: 0.5–5.0.</description>\n"
...
"            <description>Time step per iteration. Must be small for numerical stability (typically 0.0625 for 3D).</description>\n"
...
"            <description>Number of diffusion iterations.</description>\n"
...
"            <description>Curvature anisotropic diffusion filtered output NIFTI image.</description>\n"
"        </image>\n"
"    </parameters>\n"
"\n"
"</executable>\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.emplace_back("--conductance"); \
    nonbooleanFlags.emplace_back("--timeStep"); \
    nonbooleanFlags.emplace_back("--iterations"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    msg.str("");msg << "Conductance parameter. Higher values allow more diffusion. Typical range: 0.5–5.0. (value: " << conductance << ")"; \
    TCLAP::ValueArg<double > conductanceArg("", "conductance", msg.str(), false, conductance, "double", commandLine); \
 \
    msg.str("");msg << "Time step per iteration. Must be small for numerical stability (typically 0.0625 for 3D). (value: " << timeStep << ")"; \
    TCLAP::ValueArg<double > timeStepArg("", "timeStep", msg.str(), false, timeStep, "double", commandLine); \
 \
    msg.str("");msg << "Number of diffusion iterations. (value: " << iterations << ")"; \
    TCLAP::ValueArg<int > iterationsArg("", "iterations", msg.str(), false, iterations, "int", commandLine); \
 \
 ...
 \
    msg.str("");msg << "Curvature anisotropic diffusion filtered output NIFTI image.";    TCLAP::ValueArg<std::string > outputVolumeArg("", "outputVolume", msg.str(), false, outputVolume, "std::string", commandLine); \
 \
