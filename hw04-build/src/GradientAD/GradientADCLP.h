...
//  /nfs/s-l011/local/vol02/p/parthghosh/SlicerExecutionModel/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/src/GradientAD/GradientAD.xml --OutputCxx /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/hw04-build/src/GradientAD/GradientADCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>Gradient Anisotropic Diffusion Filter</title>\n"
"    <description>\n"
...
"            <description>Conductance parameter. Higher values allow more diffusion across edges. Typical range: 0.5–5.0.</description>\n"
...
"            <description>Time step per iteration. Must be small enough for numerical stability (typically 0.0625 for 3D).</description>\n"
...
"            <description>Number of diffusion iterations. More iterations produce stronger smoothing.</description>\n"
...
"            <description>Gradient anisotropic diffusion filtered output NIFTI image.</description>\n"
"        </image>\n"
"    </parameters>\n"
"\n"
"</executable>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    msg.str("");msg << "Conductance parameter. Higher values allow more diffusion across edges. Typical range: 0.5–5.0. (value: " << conductance << ")"; \
    TCLAP::ValueArg<double > conductanceArg("", "conductance", msg.str(), false, conductance, "double", commandLine); \
 \
    msg.str("");msg << "Time step per iteration. Must be small enough for numerical stability (typically 0.0625 for 3D). (value: " << timeStep << ")"; \
    TCLAP::ValueArg<double > timeStepArg("", "timeStep", msg.str(), false, timeStep, "double", commandLine); \
 \
    msg.str("");msg << "Number of diffusion iterations. More iterations produce stronger smoothing. (value: " << iterations << ")"; \
 ...
 \
    msg.str("");msg << "Gradient anisotropic diffusion filtered output NIFTI image.";    TCLAP::ValueArg<std::string > outputVolumeArg("", "outputVolume", msg.str(), false, outputVolume, "std::string", commandLine); \
 \
