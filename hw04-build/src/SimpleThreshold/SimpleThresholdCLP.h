...
//  /nfs/s-l011/local/vol02/p/parthghosh/SlicerExecutionModel/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/src/SimpleThreshold/SimpleThreshold.xml --OutputCxx /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/hw04-build/src/SimpleThreshold/SimpleThresholdCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <title>Simple Threshold Filter</title>\n"
"    <description>\n"
"        Reads a 3D signed-short NIFTI image and applies a binary threshold filter.\n"
"        Pixels whose intensity lies in [lowThreshold, highThreshold] are set to insideValue;\n"
"        all other pixels are set to outsideValue. Output is written in NIFTI format.\n"
...
"        <description>Parameters controlling the binary threshold operation.</description>\n"
"\n"
"        <double>\n"
"            <name>lowThreshold</name>\n"
"            <longflag>lowThreshold</longflag>\n"
"            <description>Lower bound of the threshold range (inclusive). Pixels at or above this AND at or below highThreshold are set to insideValue.</description>\n"
...
"            <description>Upper bound of the threshold range (inclusive). Pixels at or below this AND at or above lowThreshold are set to insideValue.</description>\n"
...
"            <description>Value assigned to pixels outside [lowThreshold, highThreshold].</description>\n"
...
"            <description>Value assigned to pixels inside [lowThreshold, highThreshold].</description>\n"
...
"            <description>3D signed-short NIFTI input image to be thresholded.</description>\n"
"        </image>\n"
"        <image>\n"
...
"            <description>Output NIFTI image after thresholding.</description>\n"
"        </image>\n"
"    </parameters>\n"
"\n"
"</executable>\n"
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    msg.str("");msg << "Lower bound of the threshold range (inclusive). Pixels at or above this AND at or below highThreshold are set to insideValue. (value: " << lowThreshold << ")"; \
    TCLAP::ValueArg<double > lowThresholdArg("", "lowThreshold", msg.str(), false, lowThreshold, "double", commandLine); \
 \
    msg.str("");msg << "Upper bound of the threshold range (inclusive). Pixels at or below this AND at or above lowThreshold are set to insideValue. (value: " << highThreshold << ")"; \
    TCLAP::ValueArg<double > highThresholdArg("", "highThreshold", msg.str(), false, highThreshold, "double", commandLine); \
 \
    msg.str("");msg << "Value assigned to pixels outside [lowThreshold, highThreshold]. (value: " << outsideValue << ")"; \
    TCLAP::ValueArg<double > outsideValueArg("", "outsideValue", msg.str(), false, outsideValue, "double", commandLine); \
 \
    msg.str("");msg << "Value assigned to pixels inside [lowThreshold, highThreshold]. (value: " << insideValue << ")"; \
    TCLAP::ValueArg<double > insideValueArg("", "insideValue", msg.str(), false, insideValue, "double", commandLine); \
 \
    msg.str("");msg << "3D signed-short NIFTI input image to be thresholded.";    TCLAP::ValueArg<std::string > inputVolumeArg("", "inputVolume", msg.str(), false, inputVolume, "std::string", commandLine); \
 \
    msg.str("");msg << "Output NIFTI image after thresholding.";    TCLAP::ValueArg<std::string > outputVolumeArg("", "outputVolume", msg.str(), false, outputVolume, "std::string", commandLine); \
 \
