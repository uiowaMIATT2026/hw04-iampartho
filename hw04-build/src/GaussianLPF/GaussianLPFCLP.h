...
//  /nfs/s-l011/local/vol02/p/parthghosh/SlicerExecutionModel/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/src/GaussianLPF/GaussianLPF.xml --OutputCxx /nfs/s-l011/local/vol02/p/parthghosh/hw04-iampartho/hw04-build/src/GaussianLPF/GaussianLPFCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"    <description>\n"
"        Applies a 3D recursive Gaussian low-pass filter to reduce noise in a NIFTI image.\n"
"        The same sigma value is applied uniformly in X, Y, and Z directions.\n"
"        Uses itk::RecursiveGaussianImageFilter. ECE:5490 HW04 — Partho Ghosh\n"
"    </description>\n"
...
"        <description>Parameters for the Gaussian low-pass filter.</description>\n"
"\n"
"        <double>\n"
"            <name>sigma</name>\n"
"            <longflag>sigma</longflag>\n"
"            <description>Standard deviation (sigma) of the Gaussian kernel in physical units. Applied equally in X, Y, and Z. Must be greater than 0.</description>\n"
"            <label>Sigma</label>\n"
"            <default>1.0</default>\n"
"            <constraints>\n"
...
"            <description>3D NIFTI input image to be smoothed.</description>\n"
"        </image>\n"
"        <image>\n"
...
"            <description>Gaussian-smoothed output NIFTI image.</description>\n"
"        </image>\n"
"    </parameters>\n"
"\n"
"</executable>\n"
...
#define GENERATE_DECLARE \
 ...
 \
    ...
    nonbooleanFlags.emplace_back("--sigma"); \
...
#define GENERATE_TCLAP_PARSE \
 ...
 \
    ...
    msg.str("");msg << "Standard deviation (sigma) of the Gaussian kernel in physical units. Applied equally in X, Y, and Z. Must be greater than 0. (value: " << sigma << ")"; \
    TCLAP::ValueArg<double > sigmaArg("", "sigma", msg.str(), false, sigma, "double", commandLine); \
 \
    msg.str("");msg << "3D NIFTI input image to be smoothed.";    TCLAP::ValueArg<std::string > inputVolumeArg("", "inputVolume", msg.str(), false, inputVolume, "std::string", commandLine); \
 \
    msg.str("");msg << "Gaussian-smoothed output NIFTI image.";    TCLAP::ValueArg<std::string > outputVolumeArg("", "outputVolume", msg.str(), false, outputVolume, "std::string", commandLine); \
 \
